       ...
       <form style={styles.container}>
        <div style={styles.login_card}>
           ...
           <div className="d-flex flex-column">
             ...
             <p className="m-2">Already Register?<Link to="/login" style={{textDecoration:'none', color:'black'}}>Login</Link></p>
           <button className="btn btn-danger w-100 mt-1" onClick={handleRegister}>Register</button>
        </div>
            <p><Link to="/" style={{textDecoration:'none', color:'black'}}>Back</Link></p>
       </form>
         </>
     )
}